 ...
 */
function generate_html_elements_function() {
    const func_list = {};
    // For each element
    for (const el of html_element_list) {
        // Build the function
        const func = function (id, classes, content, extra) {
            return (0, builder_1.builder)(el.type, id, classes, content, extra, el.end);
        };
...
console.log(html_element_functions['h1']('id', ['class'], 'content', { 'extra': 'value' }));
exports.default = html_element_functions;
